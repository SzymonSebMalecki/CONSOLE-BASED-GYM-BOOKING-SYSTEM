...
//Method for adding new Clients into table Clients
  ...
  //This methods returns ID of last Client inside the table Clients
  ...
  //This methods returns specific ID of Client inside the table Clients depending on Name, Last Name and Age entered
...
//This method updates Client details stored in table Clients
...
//Method for removing specific clients from Database
        ...
        try {
            ...
            while(COND == true){
                ...
                if(UserMemberDec.equals("SC")){
                    ...
                    Client_ID = getSpecificCLientId(DFirstName, DLastName, DAge); //For convienence of the user function finds actual ClientID from table
                    System.out.println("Client_ID" + Client_ID);
                    ...
                    String[] ar = searchForSpecificClientDetails(Client_ID); //For convienence this function gets details stored inside specific tuple and returns them
                    DFirstName = ar[0];
                    DLastName = ar[1];
...
//Method for listing contents of Table Clients
 ...
 //Method for returning data stored in Table Client
